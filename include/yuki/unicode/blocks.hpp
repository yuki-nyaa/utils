...
inline constexpr yuki::CInterval<char32_t> NB[51]={
    ...
    {0x1E960,0x1EC6F},{0x1ECC0,0x1ECFF},{0x1ED50,0x1EDFF},{0x1EF00,0x1EFFF},{0x1FC00,0x1FFFF},{0x2A6E0,0x2A6FF},{0x2EBF0,0x2F7FF},{0x2FA20,0x2FFFF},
    {0x323B0,0xDFFFF},{0xE0080,0xE00FF},{0xE01F0,0xEFFFF},
};
inline constexpr size_t NB_total=820944;
...
enum struct Block : unsigned short {
    ...
    CJK_Ext_F, CJK_Ext_G, CJK_Ext_H, CJK_Radicals_Sup, CJK_Strokes, CJK_Symbols, Compat_Jamo, Control_Pictures,
    Coptic, Coptic_Epact_Numbers, Counting_Rod, Cuneiform, Cuneiform_Numbers, Currency_Symbols, Cypriot_Syllabary, Cypro_Minoan,
    Cyrillic, Cyrillic_Ext_A, Cyrillic_Ext_B, Cyrillic_Ext_C, Cyrillic_Ext_D, Cyrillic_Sup, Deseret, Devanagari,
    Devanagari_Ext, Devanagari_Ext_A, Diacriticals, Diacriticals_Ext, Diacriticals_For_Symbols, Diacriticals_Sup, Dingbats, Dives_Akuru,
    Dogra, Domino, Duployan, Early_Dynastic_Cuneiform, Egyptian_Hieroglyph_Format_Controls, Egyptian_Hieroglyphs, Elbasan, Elymaic,
    Emoticons, Enclosed_Alphanum, Enclosed_Alphanum_Sup, Enclosed_CJK, Enclosed_Ideographic_Sup, Ethiopic, Ethiopic_Ext, Ethiopic_Ext_A,
    Ethiopic_Ext_B, Ethiopic_Sup, Geometric_Shapes, Geometric_Shapes_Ext, Georgian, Georgian_Ext, Georgian_Sup, Glagolitic,
    Glagolitic_Sup, Gothic, Grantha, Greek, Greek_Ext, Gujarati, Gunjala_Gondi, Gurmukhi,
    Half_And_Full_Forms, Half_Marks, Hangul, Hanifi_Rohingya, Hanunoo, Hatran, Hebrew, High_PU_Surrogates,
    High_Surrogates, Hiragana, IDC, Ideographic_Symbols, Imperial_Aramaic, Indic_Number_Forms, Indic_Siyaq_Numbers, Inscriptional_Pahlavi,
    Inscriptional_Parthian, IPA_Ext, Jamo, Jamo_Ext_A, Jamo_Ext_B, Javanese, Kaithi, Kaktovik_Numerals,
    Kana_Ext_A, Kana_Ext_B, Kana_Sup, Kanbun, Kangxi, Kannada, Katakana, Katakana_Ext,
    Kawi, Kayah_Li, Kharoshthi, Khitan_Small_Script, Khmer, Khmer_Symbols, Khojki, Khudawadi,
    Lao, Latin_1_Sup, Latin_Ext_A, Latin_Ext_Additional, Latin_Ext_B, Latin_Ext_C, Latin_Ext_D, Latin_Ext_E,
    Latin_Ext_F, Latin_Ext_G, Lepcha, Letterlike_Symbols, Limbu, Linear_A, Linear_B_Ideograms, Linear_B_Syllabary,
    Lisu, Lisu_Sup, Low_Surrogates, Lycian, Lydian, Mahajani, Mahjong, Makasar,
    Malayalam, Mandaic, Manichaean, Marchen, Masaram_Gondi, Math_Alphanum, Math_Operators, Mayan_Numerals,
    Medefaidrin, Meetei_Mayek, Meetei_Mayek_Ext, Mende_Kikakui, Meroitic_Cursive, Meroitic_Hieroglyphs, Miao, Misc_Arrows,
    Misc_Math_Symbols_A, Misc_Math_Symbols_B, Misc_Pictographs, Misc_Symbols, Misc_Technical, Modi, Modifier_Letters, Modifier_Tone_Letters,
    Mongolian, Mongolian_Sup, Mro, Multani, Music, Myanmar, Myanmar_Ext_A, Myanmar_Ext_B,
    Nabataean, Nag_Mundari, Nandinagari, New_Tai_Lue, Newa, NKo, Number_Forms, Nushu,
    Nyiakeng_Puachue_Hmong, OCR, Ogham, Ol_Chiki, Old_Hungarian, Old_Italic, Old_North_Arabian, Old_Permic,
    Old_Persian, Old_Sogdian, Old_South_Arabian, Old_Turkic, Old_Uyghur, Oriya, Ornamental_Dingbats, Osage,
    Osmanya, Ottoman_Siyaq_Numbers, Pahawh_Hmong, Palmyrene, Pau_Cin_Hau, Phags_Pa, Phaistos, Phoenician,
    Phonetic_Ext, Phonetic_Ext_Sup, Playing_Cards, Psalter_Pahlavi, PUA, Punctuation, Rejang, Rumi,
    Runic, Samaritan, Saurashtra, Sharada, Shavian, Shorthand_Format_Controls, Siddham, Sinhala,
    Sinhala_Archaic_Numbers, Small_Forms, Small_Kana_Ext, Sogdian, Sora_Sompeng, Soyombo, Specials, Sundanese,
    Sundanese_Sup, Sup_Arrows_A, Sup_Arrows_B, Sup_Arrows_C, Sup_Math_Operators, Sup_PUA_A, Sup_PUA_B, Sup_Punctuation,
    Sup_Symbols_And_Pictographs, Super_And_Sub, Sutton_SignWriting, Syloti_Nagri, Symbols_And_Pictographs_Ext_A, Symbols_For_Legacy_Computing, Syriac, Syriac_Sup,
    Tagalog, Tagbanwa, Tags, Tai_Le, Tai_Tham, Tai_Viet, Tai_Xuan_Jing, Takri,
    Tamil, Tamil_Sup, Tangsa, Tangut, Tangut_Components, Tangut_Sup, Telugu, Thaana,
    Thai, Tibetan, Tifinagh, Tirhuta, Toto, Transport_And_Map, UCAS, UCAS_Ext,
    UCAS_Ext_A, Ugaritic, Vai, Vedic_Ext, Vertical_Forms, Vithkuqi, VS, VS_Sup,
    Wancho, Warang_Citi, Yezidi, Yi_Radicals, Yi_Syllables, Yijing, Zanabazar_Square, Znamenny_Music,
    total_
}; // enum struct Block


inline constexpr Name_CC_Num<Block> block_table[328]={
    ...
    {"CJK_Ext_F",CJK_Ext_F,56},{"CJK_Ext_G",CJK_Ext_G,57},{"CJK_Ext_H",CJK_Ext_H,58},{"CJK_Radicals_Sup",CJK_Radicals_Sup,59},
    {"CJK_Strokes",CJK_Strokes,60},{"CJK_Symbols",CJK_Symbols,61},{"Compat_Jamo",Compat_Jamo,62},{"Control_Pictures",Control_Pictures,63},
    {"Coptic",Coptic,64},{"Coptic_Epact_Numbers",Coptic_Epact_Numbers,65},{"Counting_Rod",Counting_Rod,66},{"Cuneiform",Cuneiform,67},
    {"Cuneiform_Numbers",Cuneiform_Numbers,68},{"Currency_Symbols",Currency_Symbols,69},{"Cypriot_Syllabary",Cypriot_Syllabary,70},{"Cypro_Minoan",Cypro_Minoan,71},
    {"Cyrillic",Cyrillic,72},{"Cyrillic_Ext_A",Cyrillic_Ext_A,73},{"Cyrillic_Ext_B",Cyrillic_Ext_B,74},{"Cyrillic_Ext_C",Cyrillic_Ext_C,75},
    {"Cyrillic_Ext_D",Cyrillic_Ext_D,76},{"Cyrillic_Sup",Cyrillic_Sup,77},{"Deseret",Deseret,78},{"Devanagari",Devanagari,79},
    {"Devanagari_Ext",Devanagari_Ext,80},{"Devanagari_Ext_A",Devanagari_Ext_A,81},{"Diacriticals",Diacriticals,82},{"Diacriticals_Ext",Diacriticals_Ext,83},
    {"Diacriticals_For_Symbols",Diacriticals_For_Symbols,84},{"Diacriticals_Sup",Diacriticals_Sup,85},{"Dingbats",Dingbats,86},{"Dives_Akuru",Dives_Akuru,87},
    {"Dogra",Dogra,88},{"Domino",Domino,89},{"Duployan",Duployan,90},{"Early_Dynastic_Cuneiform",Early_Dynastic_Cuneiform,91},
    {"Egyptian_Hieroglyph_Format_Controls",Egyptian_Hieroglyph_Format_Controls,92},{"Egyptian_Hieroglyphs",Egyptian_Hieroglyphs,93},{"Elbasan",Elbasan,94},{"Elymaic",Elymaic,95},
    {"Emoticons",Emoticons,96},{"Enclosed_Alphanum",Enclosed_Alphanum,97},{"Enclosed_Alphanum_Sup",Enclosed_Alphanum_Sup,98},{"Enclosed_CJK",Enclosed_CJK,99},
    {"Enclosed_Ideographic_Sup",Enclosed_Ideographic_Sup,100},{"Ethiopic",Ethiopic,101},{"Ethiopic_Ext",Ethiopic_Ext,102},{"Ethiopic_Ext_A",Ethiopic_Ext_A,103},
    {"Ethiopic_Ext_B",Ethiopic_Ext_B,104},{"Ethiopic_Sup",Ethiopic_Sup,105},{"Geometric_Shapes",Geometric_Shapes,106},{"Geometric_Shapes_Ext",Geometric_Shapes_Ext,107},
    {"Georgian",Georgian,108},{"Georgian_Ext",Georgian_Ext,109},{"Georgian_Sup",Georgian_Sup,110},{"Glagolitic",Glagolitic,111},
    {"Glagolitic_Sup",Glagolitic_Sup,112},{"Gothic",Gothic,113},{"Grantha",Grantha,114},{"Greek",Greek,115},
    {"Greek_Ext",Greek_Ext,116},{"Gujarati",Gujarati,117},{"Gunjala_Gondi",Gunjala_Gondi,118},{"Gurmukhi",Gurmukhi,119},
    {"Half_And_Full_Forms",Half_And_Full_Forms,120},{"Half_Marks",Half_Marks,121},{"Hangul",Hangul,122},{"Hanifi_Rohingya",Hanifi_Rohingya,123},
    {"Hanunoo",Hanunoo,124},{"Hatran",Hatran,125},{"Hebrew",Hebrew,126},{"High_PU_Surrogates",High_PU_Surrogates,127},
    {"High_Surrogates",High_Surrogates,128},{"Hiragana",Hiragana,129},{"IDC_blk",IDC_blk,130},{"Ideographic_Symbols",Ideographic_Symbols,131},
    {"Imperial_Aramaic",Imperial_Aramaic,132},{"Indic_Number_Forms",Indic_Number_Forms,133},{"Indic_Siyaq_Numbers",Indic_Siyaq_Numbers,134},{"Inscriptional_Pahlavi",Inscriptional_Pahlavi,135},
    {"Inscriptional_Parthian",Inscriptional_Parthian,136},{"IPA_Ext",IPA_Ext,137},{"Jamo",Jamo,138},{"Jamo_Ext_A",Jamo_Ext_A,139},
    {"Jamo_Ext_B",Jamo_Ext_B,140},{"Javanese",Javanese,141},{"Kaithi",Kaithi,142},{"Kaktovik_Numerals",Kaktovik_Numerals,143},
    {"Kana_Ext_A",Kana_Ext_A,144},{"Kana_Ext_B",Kana_Ext_B,145},{"Kana_Sup",Kana_Sup,146},{"Kanbun",Kanbun,147},
    {"Kangxi",Kangxi,148},{"Kannada",Kannada,149},{"Katakana",Katakana,150},{"Katakana_Ext",Katakana_Ext,151},
    {"Kawi_blk",Kawi_blk,152},{"Kayah_Li",Kayah_Li,153},{"Kharoshthi",Kharoshthi,154},{"Khitan_Small_Script",Khitan_Small_Script,155},
    {"Khmer",Khmer,156},{"Khmer_Symbols",Khmer_Symbols,157},{"Khojki",Khojki,158},{"Khudawadi",Khudawadi,159},
    {"Lao",Lao,160},{"Latin_1_Sup",Latin_1_Sup,161},{"Latin_Ext_A",Latin_Ext_A,162},{"Latin_Ext_Additional",Latin_Ext_Additional,163},
    {"Latin_Ext_B",Latin_Ext_B,164},{"Latin_Ext_C",Latin_Ext_C,165},{"Latin_Ext_D",Latin_Ext_D,166},{"Latin_Ext_E",Latin_Ext_E,167},
    {"Latin_Ext_F",Latin_Ext_F,168},{"Latin_Ext_G",Latin_Ext_G,169},{"Lepcha",Lepcha,170},{"Letterlike_Symbols",Letterlike_Symbols,171},
    {"Limbu",Limbu,172},{"Linear_A",Linear_A,173},{"Linear_B_Ideograms",Linear_B_Ideograms,174},{"Linear_B_Syllabary",Linear_B_Syllabary,175},
    {"Lisu_blk",Lisu_blk,176},{"Lisu_Sup",Lisu_Sup,177},{"Low_Surrogates",Low_Surrogates,178},{"Lycian",Lycian,179},
    {"Lydian",Lydian,180},{"Mahajani",Mahajani,181},{"Mahjong",Mahjong,182},{"Makasar",Makasar,183},
    {"Malayalam",Malayalam,184},{"Mandaic",Mandaic,185},{"Manichaean",Manichaean,186},{"Marchen",Marchen,187},
    {"Masaram_Gondi",Masaram_Gondi,188},{"Math_Alphanum",Math_Alphanum,189},{"Math_Operators",Math_Operators,190},{"Mayan_Numerals",Mayan_Numerals,191},
    {"Medefaidrin",Medefaidrin,192},{"Meetei_Mayek",Meetei_Mayek,193},{"Meetei_Mayek_Ext",Meetei_Mayek_Ext,194},{"Mende_Kikakui",Mende_Kikakui,195},
    {"Meroitic_Cursive",Meroitic_Cursive,196},{"Meroitic_Hieroglyphs",Meroitic_Hieroglyphs,197},{"Miao",Miao,198},{"Misc_Arrows",Misc_Arrows,199},
    {"Misc_Math_Symbols_A",Misc_Math_Symbols_A,200},{"Misc_Math_Symbols_B",Misc_Math_Symbols_B,201},{"Misc_Pictographs",Misc_Pictographs,202},{"Misc_Symbols",Misc_Symbols,203},
    {"Misc_Technical",Misc_Technical,204},{"Modi_blk",Modi_blk,205},{"Modifier_Letters",Modifier_Letters,206},{"Modifier_Tone_Letters",Modifier_Tone_Letters,207},
    {"Mongolian",Mongolian,208},{"Mongolian_Sup",Mongolian_Sup,209},{"Mro",Mro,210},{"Multani",Multani,211},
    {"Music",Music,212},{"Myanmar",Myanmar,213},{"Myanmar_Ext_A",Myanmar_Ext_A,214},{"Myanmar_Ext_B",Myanmar_Ext_B,215},
    {"Nabataean",Nabataean,216},{"Nag_Mundari",Nag_Mundari,217},{"Nandinagari",Nandinagari,218},{"New_Tai_Lue",New_Tai_Lue,219},
    {"Newa_blk",Newa_blk,220},{"NKo",NKo,221},{"Number_Forms",Number_Forms,222},{"Nushu",Nushu,223},
    {"Nyiakeng_Puachue_Hmong",Nyiakeng_Puachue_Hmong,224},{"OCR",OCR,225},{"Ogham",Ogham,226},{"Ol_Chiki",Ol_Chiki,227},
    {"Old_Hungarian",Old_Hungarian,228},{"Old_Italic",Old_Italic,229},{"Old_North_Arabian",Old_North_Arabian,230},{"Old_Permic",Old_Permic,231},
    {"Old_Persian",Old_Persian,232},{"Old_Sogdian",Old_Sogdian,233},{"Old_South_Arabian",Old_South_Arabian,234},{"Old_Turkic",Old_Turkic,235},
    {"Old_Uyghur",Old_Uyghur,236},{"Oriya",Oriya,237},{"Ornamental_Dingbats",Ornamental_Dingbats,238},{"Osage",Osage,239},
    {"Osmanya",Osmanya,240},{"Ottoman_Siyaq_Numbers",Ottoman_Siyaq_Numbers,241},{"Pahawh_Hmong",Pahawh_Hmong,242},{"Palmyrene",Palmyrene,243},
    {"Pau_Cin_Hau",Pau_Cin_Hau,244},{"Phags_Pa",Phags_Pa,245},{"Phaistos",Phaistos,246},{"Phoenician",Phoenician,247},
    {"Phonetic_Ext",Phonetic_Ext,248},{"Phonetic_Ext_Sup",Phonetic_Ext_Sup,249},{"Playing_Cards",Playing_Cards,250},{"Psalter_Pahlavi",Psalter_Pahlavi,251},
    {"PUA",PUA,252},{"Punctuation",Punctuation,253},{"Rejang",Rejang,254},{"Rumi",Rumi,255},
    {"Runic",Runic,256},{"Samaritan",Samaritan,257},{"Saurashtra",Saurashtra,258},{"Sharada",Sharada,259},
    {"Shavian",Shavian,260},{"Shorthand_Format_Controls",Shorthand_Format_Controls,261},{"Siddham",Siddham,262},{"Sinhala",Sinhala,263},
    {"Sinhala_Archaic_Numbers",Sinhala_Archaic_Numbers,264},{"Small_Forms",Small_Forms,265},{"Small_Kana_Ext",Small_Kana_Ext,266},{"Sogdian",Sogdian,267},
    {"Sora_Sompeng",Sora_Sompeng,268},{"Soyombo",Soyombo,269},{"Specials",Specials,270},{"Sundanese",Sundanese,271},
    {"Sundanese_Sup",Sundanese_Sup,272},{"Sup_Arrows_A",Sup_Arrows_A,273},{"Sup_Arrows_B",Sup_Arrows_B,274},{"Sup_Arrows_C",Sup_Arrows_C,275},
    {"Sup_Math_Operators",Sup_Math_Operators,276},{"Sup_PUA_A",Sup_PUA_A,277},{"Sup_PUA_B",Sup_PUA_B,278},{"Sup_Punctuation",Sup_Punctuation,279},
    {"Sup_Symbols_And_Pictographs",Sup_Symbols_And_Pictographs,280},{"Super_And_Sub",Super_And_Sub,281},{"Sutton_SignWriting",Sutton_SignWriting,282},{"Syloti_Nagri",Syloti_Nagri,283},
    {"Symbols_And_Pictographs_Ext_A",Symbols_And_Pictographs_Ext_A,284},{"Symbols_For_Legacy_Computing",Symbols_For_Legacy_Computing,285},{"Syriac",Syriac,286},{"Syriac_Sup",Syriac_Sup,287},
    {"Tagalog",Tagalog,288},{"Tagbanwa",Tagbanwa,289},{"Tags",Tags,290},{"Tai_Le",Tai_Le,291},
    {"Tai_Tham",Tai_Tham,292},{"Tai_Viet",Tai_Viet,293},{"Tai_Xuan_Jing",Tai_Xuan_Jing,294},{"Takri",Takri,295},
    {"Tamil",Tamil,296},{"Tamil_Sup",Tamil_Sup,297},{"Tangsa",Tangsa,298},{"Tangut",Tangut,299},
    {"Tangut_Components",Tangut_Components,300},{"Tangut_Sup",Tangut_Sup,301},{"Telugu",Telugu,302},{"Thaana",Thaana,303},
    {"Thai_blk",Thai_blk,304},{"Tibetan",Tibetan,305},{"Tifinagh",Tifinagh,306},{"Tirhuta",Tirhuta,307},
    {"Toto_blk",Toto_blk,308},{"Transport_And_Map",Transport_And_Map,309},{"UCAS",UCAS,310},{"UCAS_Ext",UCAS_Ext,311},
    {"UCAS_Ext_A",UCAS_Ext_A,312},{"Ugaritic",Ugaritic,313},{"Vai",Vai,314},{"Vedic_Ext",Vedic_Ext,315},
    {"Vertical_Forms",Vertical_Forms,316},{"Vithkuqi",Vithkuqi,317},{"VS_blk",VS_blk,318},{"VS_Sup",VS_Sup,319},
    {"Wancho",Wancho,320},{"Warang_Citi",Warang_Citi,321},{"Yezidi",Yezidi,322},{"Yi_Radicals",Yi_Radicals,323},
    {"Yi_Syllables",Yi_Syllables,324},{"Yijing",Yijing,325},{"Zanabazar_Square",Zanabazar_Square,326},{"Znamenny_Music",Znamenny_Music,327},
};
