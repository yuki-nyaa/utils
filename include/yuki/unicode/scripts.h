...
inline constexpr yuki::CInterval<char32_t> Zyyy[173]={
    ...
    {0x3008,0x3020},{0x3030,0x3037},{0x303C,0x303F},{0x309B,0x309C},{0x30A0,0x30A0},{0x30FB,0x30FC},{0x3190,0x319F},{0x31C0,0x31E3},
...
inline constexpr size_t Zyyy_total=8306;
...
inline constexpr yuki::CInterval<char32_t> Mlym[12]={
...
inline constexpr size_t Mlym_total=127;


inline constexpr yuki::CInterval<char32_t> Sinh[15]={
...
inline constexpr size_t Sinh_total=114;
...
inline constexpr yuki::CInterval<char32_t> Hani[39]={
...
inline constexpr size_t Hani_total=99318;
...
inline constexpr yuki::CInterval<char32_t> Shrd[8]={
    {0x951,0x951},{0x1CD7,0x1CD7},{0x1CD9,0x1CD9},{0x1CDC,0x1CDD},{0x1CE0,0x1CE0},{0xA830,0xA835},{0xA838,0xA838},{0x11180,0x111DF},
};
inline constexpr size_t Shrd_total=109;
...
inline constexpr size_t Zzzz_total=964234;
